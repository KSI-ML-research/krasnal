...
from .source import OnlineCotDataSource, load_raw_games
    ...
    try:
        ...
        with OnlineCotDataSource(
            ...
            while not stop_event.is_set():
                ...
                attempts_delta = source.stats.attempts - last_attempts
                last_attempts = source.stats.attempts
                with attempts_value.get_lock():
                    attempts_value.value += attempts_delta
                while not stop_event.is_set():
                    try:
...
class CotProducerPool:
    ...
    def __init__(
        ...
        *,
        ...
        self.attempts_value = self.ctx.Value("q", 0)
        ...
        self.processes = [
            self.ctx.Process(
                ...
                kwargs={
                    ...
                    "attempts_value": self.attempts_value,
    ...
    def attempts(self) -> int:
        """Return the number of producer attempts so far."""
        with self.attempts_value.get_lock():
            return int(self.attempts_value.value)
