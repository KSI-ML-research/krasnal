...
from krasnal.tokens import ELO_1500_1599_ID, IS_CHECK_ID, PIECE_TYPE_MOVED_ID, TC_BLITZ_INC_ID


def test_apply_supervised_loss_mask_matches_collate_policy():
    y = torch.tensor(
        [IS_CHECK_ID, ELO_1500_1599_ID, TC_BLITZ_INC_ID, PIECE_TYPE_MOVED_ID, 500],
        dtype=torch.long,
    )
