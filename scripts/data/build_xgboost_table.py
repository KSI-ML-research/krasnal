...
time_initial, time_increment) and model_move_probs (generated by
generate_move_probs.py). All columns in _REQUIRED_COLUMNS must be present.
"""
...
def _explode_to_moves(games: pl.DataFrame) -> pl.DataFrame:
    ...
    rename_map = {
        ...
        "entropy_x_ply_scaling": "entropy_x_ply_scaling",
    }
    ...
    return moves.with_columns(
        pl.col("move_entropy").cast(pl.Float64),
        pl.col("entropy_x_ply_scaling").cast(pl.Float64),
    )
